const HomePage = () => {
    ...
    return (
        <div className="card bg-gray-600 text-primary-content">
            <h1 className="mb-3 text-indigo align-middle underline">Readme</h1>
            <div className="mockup-code mb-5">
                <h2 className="font-bold underline m-3 px-5 card-title">Description</h2>
                <pre className="card-body bordered border-r-4 ml-3">
                ...
                <pre className="card-body bg-indigo-600 rounded bordered border-r-4 mt-4 ml-3">
